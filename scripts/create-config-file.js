...
const config = {
  ...
  http: {
    proxyConfig: {
      ...
      EODH_PLANET_CATALOGUE_API_URL: getVariableValue(process.env.VITE_EODH_PLANET_CATALOGUE_API_URL),
      EODH_WORKFLOW_CATALOGUE_API_URL: getVariableValue(process.env.VITE_EODH_WORKFLOW_CATALOGUE_API_URL),
      EODH_ELEMENT_84_CATALOGUE_INFO_API_URL: getVariableValue(process.env.VITE_EODH_ELEMENT_84_CATALOGUE_INFO_API_URL),
      EODH_PLANET_CATALOGUE_INFO_API_URL: getVariableValue(process.env.VITE_EODH_PLANET_CATALOGUE_INFO_API_URL),
    },
  },
  translation: {

...
const config = {
  ...
  feature: {
    search: getVariableValue(process.env.VITE_FEATURE_FLAG_SEARCH),
    actionCreator: getVariableValue(process.env.VITE_FEATURE_FLAG_ACTION_CREATOR),
    toggleLayerButton: getVariableValue(process.env.VITE_FEATURE_FLAG_TOGGLE_LAYER_BUTTON),
    clearLayerButton: getVariableValue(process.env.VITE_FEATURE_FLAG_CLEAR_LAYER_BUTTON),
  },
};

...
const multipleElementsMock = {
  cdom: {
    ...
    'proj:transform': [
      0.00012055852166620698, 0.0, -2.6527776186772343, 0.0, -0.00012055852166622246, 51.35460363372064, 0.0, 0.0, 1.0,
    ],
    colormap: {
      name: 'jet',
      reversed: false,
...
export const singleResultInItemMock = genericMock(singleElementMock);
export const multipleResultsInItemMock = genericMock(multipleElementsMock);

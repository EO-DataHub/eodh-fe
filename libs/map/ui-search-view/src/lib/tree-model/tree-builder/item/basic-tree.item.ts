...
import {
  ...
  IDynamicValueControl, ISimpleControl, IValueControl,
  TControlType,
} from '../../tree.model';
import { createControl } from '../control/create.control';
import { Tree } from '../tree.builder';

export class BasicTreeItem<Control extends SimpleControl | ValueControl = SimpleControl | ValueControl> implements IBaseItem<Control> {
  public id: string;
  public parent: BasicTreeItem<SimpleControl | ValueControl> | Tree;
  public translationKey: string;
  public control: Control;

  public constructor(id: string | undefined, props: IDynamicBaseItem<IDynamicValueControl | IDynamicSimpleControl | TControlType> | IBaseItem<ISimpleControl | IValueControl>, control: IDynamicValueControl | IDynamicSimpleControl | TControlType | ISimpleControl | IValueControl | undefined, parent: BasicTreeItem<SimpleControl | ValueControl> | Tree) {

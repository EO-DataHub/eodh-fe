...
export const Sentinel2 = () => {
  ...
  return (
    <SatelliteItem title='MAP.SEARCH_VIEW.COPERNICUS.SENTINEL_2.NAME' name='dataSets.copernicus.sentinel2.enabled'>
      <SettingsItem
        title='MAP.SEARCH_VIEW.COPERNICUS.SENTINEL_2.SETTINGS.L1C'
        name='dataSets.copernicus.sentinel2.l1c'
      />
      <SettingsItem
        title='MAP.SEARCH_VIEW.COPERNICUS.SENTINEL_2.SETTINGS.L2A'

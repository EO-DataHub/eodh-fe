export const presetStyles = {
  ...
  imageContainer: 'overflow-hidden w-20 h-20 min-w-20',
  image: 'w-full h-full object-center object-cover rounded-md',
  presetContainer: 'flex bg-background-main p-4 rounded-md min-h-28 w-full',

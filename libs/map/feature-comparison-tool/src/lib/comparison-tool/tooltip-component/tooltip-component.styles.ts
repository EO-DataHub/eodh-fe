export const styles = {
  ...
  comparisonTool:
    'flex justify-normal items-center absolute transform top-[82px] -translate-x-1/2 left-1/2 right-1/2 p-6 z-30 bg-bright-main rounded-md shadow-action-creator w-[710px]',
};

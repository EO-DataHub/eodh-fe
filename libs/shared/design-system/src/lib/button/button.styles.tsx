...
export const getAppearanceStyles = (
  ...
  const appearanceStyles = {
    ...
    text: `${visited ? 'text-text-visited' : 'text-primary'} underline ${isActive ? 'border-primary-light' : ''}`,
  };
...
export const getDisabledStyles = (
  ...
  const disabledStyles = {
    ...
    'outlined-white': disabled
      ? 'border-text-disabled text-text-disabled hover:border-text-disabled cursor-not-allowed'
      : '',

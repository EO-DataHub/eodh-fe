        ...
        ACTION_CREATOR: {
          ...
          QUESTIONS: {
            ...
            WORKING_WITH_ACTIONS: {
              ...
              WHAT_IS_NBR_SCENARIO: {
                QUESTION: 'What is Normalized Burn Ratio scenario?';
                ANSWER_TEXT_1: 'The Normalized Burn Ratio (NBR) scenario is designed to help users detect and assess burned areas and fire severity using satellite imagery. By leveraging Sentinel 2 imagery (Level-2A and Analysis Ready Data), it calculates the NBR spectral index, which highlights changes in vegetation health and structure caused by wildfires or other disturbances.';
                ANSWER_TEXT_2: 'NBR is particularly effective for identifying recently burned areas, estimating burn severity, and monitoring vegetation recovery over time.';
                ANSWER_TEXT_3: 'It can be used for:';
                USE_CASE_1: 'Burned Area Detection: Identify regions affected by wildfires or controlled burns.';
                USE_CASE_2: 'Fire Severity Assessment: Distinguish between low, moderate, and high burn severity zones.';
                USE_CASE_3: 'Post-Fire Recovery Monitoring: Track vegetation regrowth and ecosystem recovery over time.';
                USE_CASE_4: 'Forest and Land Management: Support decision-making for reforestation, restoration, and risk mitigation.';
                USE_CASE_5: 'Environmental Impact Analysis: Evaluate how fires affect landscapes, habitats, and carbon cycles.';
                ANSWER_TEXT_4: 'Workflow explanation:';
                WORKFLOW_STEP_1: 'Data Ingestion: The preset retrieves Sentinel-2 Level-2A or Analysis Ready Data (ARD).';
                WORKFLOW_STEP_2: 'Spectral Index Calculation (NBR): The workflow computes the Normalized Burn Ratio using Near-Infrared (NIR) and Shortwave Infrared (SWIR) bands. Healthy vegetation reflects strongly in NIR and weakly in SWIR, while burned areas show the opposite pattern—making NBR effective for fire analysis.';
                WORKFLOW_STEP_3: "Result Storage: The generated NBR outputs are stored as raster datasets within the user's workspace as STAC collections, ensuring easy access and interoperability within EOPro.";
                WORKFLOW_STEP_4: 'Visualisation: In the EOPro interface, users can explore NBR results as color-coded raster layers (e.g., red tones indicating burned areas and higher severity). Time-series comparisons enable users to visually assess fire impact and recovery trends.';
              };
              ...
              WHAT_IS_THE_COLOUR_CODING_FOR_NBR: {
                QUESTION: 'What is the colour coding for NBR?';
                IMAGE_ALT: 'NBR colour coding';
              };
    ...
    MAP: {
      ...
      ACTION_CREATOR_PANEL: {
        ...
        HISTORY: {
          ...
          DELETE_CONFIRMATION: {
            WARNING: 'Warning!';
            MESSAGE_DELETE: 'Are you sure you want to delete this workflow? This action cannot be undone.';
            MESSAGE_CANCEL: 'Are you sure you want to cancel this workflow? This action cannot be undone.';
            YES_CTA_DELETE: 'Yes, delete';
            YES_CTA_CANCEL: 'Yes, cancel';
            NO_CTA_DELETE: 'Do not delete';
            NO_CTA_CANCEL: 'Do not cancel';
            DELETING: 'Deleting';

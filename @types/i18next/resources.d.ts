          ...
          "QUESTIONS": {
            ...
            "EXECUTING_AND_TRACKING_WORKFLOWS": {
              ...
              "HOW_DO_I_CANCEL_A_RUNNING_WORKFLOW": {
                ...
                "ANSWER": [
                  "Currently, running workflows cannot be cancelled."
                ]
              },
        ...
        "QUESTIONS": {
          ...
          "SEARCH_MODULE_FUNCIONALITY": {
            ...
            "WHAT_HAPPENS_WHEN_I_RUN_A_SEARCH": {
              ...
              "ANSWER": [
                "The system processes your dataset, AOI (Area of Intrest), and date range. Results appear in the left panel as thumbnails. Footprints of matching assets are displayed on the map. The time slider becomes available to refine results."
              ]
            },
          ...
          "VIEWING_AND_PURCHASING_SEARCH_RESULTS": {
            ...
            "HOW_DO_I_DISPLAY_PURCHASED_ITEMS_ON_THE_MAP": {
              ...
              "ANSWER": [
                "In 'My Items', click 'View' to load the purchased asset on the map."
              ]
            }
          },
          ...
          "GENERAL_FEATURES_USER_SETTINGS": {
            ...
            "HOW_DO_I_DOWNLOAD_A_WORKFLOW_OR_SEARCH_RESULTS": {
              "QUESTION": "How do I download a workflow or search results?",
              "ANSWER": [
                "Click the 'Download' button next to a result in Search or Action Creator. A respective files for a particular item will be downloaded."
              ]
            }
          }
        }

        ...
        QUESTIONS: {
          ...
          SEARCH_MODULE_FUNCIONALITY: {
            ...
            WHAT_HAPPENS_WHEN_I_RUN_A_SEARCH: {
              ...
              ANSWER: [
                'The system processes your dataset, AOI, and date range. Results appear in the left panel as thumbnails. Footprints of matching assets are displayed on the map. The time slider becomes available to refine results.'
              ];
            };

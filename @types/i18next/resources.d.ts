    ...
    "MAP": {
      "ACTION_CREATOR_PANEL": {
        ...
        "HELP": {
          ...
          "SUBTITLES": {
            "GENERAL_FUNCIONALITY": "General functionality",
            "MANAGING_DATASETS_AND_FUNCTIONS_IN_AC": "Managing Datasets & Functions in Action Creator",
            "EXECUTING_AND_TRACKING_WORKFLOWS": "Executing & Tracking Workflows",
            "WORKING_WITH_GRAPHS": "Working with Graphs",
            "MEASUREMENT_AOI_MANAGEMENT": "Measurement & AOI Management",
            "COMPARISON_AND_LAYER_MANAGEMENT": "Comparison & Layer Management"
          },
          "QUESTIONS": {
            "WHAT_IS_THE_AC": {

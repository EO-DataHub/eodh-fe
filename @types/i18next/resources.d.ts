            ...
            GETTING_STARTED_WITH_AC: {
              ...
              WHAT_ARE_WORKFLOW_PRESETS_AND_HOW_DO_I_USE_THEM: {
                ...
                ANSWER: [
                  ...
                  'Detailed description of presents can be found in a separate section.'
                ];
              };
            ...
            WORKING_WITH_ACTIONS: {
              ...
              WHAT_IS_LAND_COVER_CHANGE_SCENARIO: {
                ...
                ANSWER: [
                  ...
                  [
                    'Data Ingestion: The system takes in relevant land cover datasets—CORINE, ESA GLCM, and CLMS Water Bodies.',
        ...
        QUESTIONS: {
          GENERAL_FUNCIONALITY: {
            ...
            WHAT_IS_EOPRO: {
              ...
              ANSWER: [
                'EOPro is an advanced web-based platform for Earth Observation data processing with an intuitive interface, designed to monitor and analyse land cover changes over time using comprehensive satellite-based data sourced from the EODH platform. The platform enables you to seamlessly browse, select, compare, visualise, and process both commercial and public datasets through a dynamic pan-and-zoom mapping interface. '
              ];
            };
            HOW_DO_I_GET_STARTED: {
              QUESTION: 'How do I get started?';
              ANSWER: [
                'To begin accessing the imaging data, you can use the Search Module from the left menu, draw an area of interest using the drawing tools at the top of the screen, and define a data range near the search button bottom-left. Once you’ve configured all these options, clicking the search button will return results (or let you know if you need to refine your search parameters in any way) that you can view on the main map.',
                'If you’d like to take your search further, you can log in using the button at the top-right of the screen to take advantage of the Action Creator (see below for more information on how this functions). '
              ];
            };
            DO_I_NEED_ACCOUNT: {
              QUESTION: 'Do I need to create an account?';
              ANSWER: [
                'No, but if you want to get the most out of the imaging data EOPro has access to, we would recommend logging in so you can use all the advanced features of the Action Creator.'
              ];
            };
          };
          SEARCH_MODULE_FUNCIONALITY: {
            ...
            WHAT_IS_THE_SEARCH_MODULE: {
              ...
              ANSWER: [
                'The Search Module allows users to find satellite imagery based on a specified Area of Interest (AOI), date range, and selected dataset(s). Once a search is performed, the system displays results as thumbnails in the left panel and footprints on the map for geographic reference.'
              ];
            };
            HOW_DO_I_SELECT_A_DATA_SET_AS_PART_OF_A_SEARCH: {
              QUESTION: 'How do I select a Data Set as part of a search?';
              ANSWER: [
                'Click on the Data Set Selection Menu on the left panel. Browse through available public and commercial datasets. Click on a Data Set to select it. If applicable, configure advanced settings.'
              ];
            };
            ...
            WHAT_HAPPENS_WHEN_I_RUN_A_SEARCH: {
              ...
              ANSWER: [
                'The system processes your dataset, AOI (Area of Interest), and date range. Results appear in the left panel as thumbnails. Footprints of matching assets are displayed on the map. The time slider becomes available to refine results.'
              ];
            };
            HOW_DO_I_REFINE_OR_MODIFY_MY_SEARCH_PARAMETERS: {
              ...
              ANSWER: [
                [
                  ...
                  'Change Data set: Click on the dataset selector and choose a new dataset.',
            ...
            HOW_DO_I_USE_ADVANCED_SEARCH_OPTIONS_FOR_DATASETS: {
              QUESTION: 'How do I use advanced search options for datasets?';
              ANSWER: [
                'For datasets like Sentinel-1, toggle Advanced Search in the dataset panel. Configure acquisition modes, orbit direction, polarisation settings, etc. These settings affect search results based on data set-specific filtering.'
              ];
            };
            WHAT_IS_THE_DIFFERENCE_BETWEEN_PUBLIC_AND_COMMERCIAL_DATASETS: {
              QUESTION: 'What is the difference between public and commercial datasets?';
              ANSWER: [
                [
          ...
          VIEWING_AND_PURCHASING_SEARCH_RESULTS: {
            SUBTITLE: 'Viewing & Purchasing Search Results';
            ...
            HOW_DO_I_PURCHASE_COMMERCIAL_DATA: {
              ...
              ANSWER: [
                "Click 'Purchase' next to a commercial dataset. You will be redirected to the TPZ portal to accept terms and complete the transaction. After purchase, the item appears in My Items."
              ];
            };
          ...
          TIME_MANAGEMENT_IN_SEARCH: {
            ...
            HOW_DOES_THE_TIME_SLIDER_AFFECT_SEARCH_RESULTS: {
              ...
              ANSWER: [
                'The time slider allows you to filter results dynamically by narrowing the displayed time range. Moving the slider updates results in real-time without re-running the search.'
              ];
            };
          };
          COMPARISON_AND_EXPORTING: {
            ...
            HOW_DO_I_ADD_SEARCH_RESULTS_TO_THE_COMPARISON_TOOL: {
              ...
              ANSWER: [
                "Click 'Add to Compare' on a search result. Add a second asset to enable the comparison tool. Use the comparison swipe to analyse differences."
              ];
            };
          };
